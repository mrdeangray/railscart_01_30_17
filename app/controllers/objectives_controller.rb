...
def drums
  @objectives = Objective.all.where('category = "Drums"')
end

def bass
  @objectives = Objective.all.where('category = "Bass"')
end

def piano
  @objectives = Objective.all.where('category = "Piano"')
end

def guitar
  @objectives = Objective.all.where('category = "Guitar"')
end
  ...
  private
    ...
    def objective_params
      params.require(:objective).permit(:category, :title)
    end
end
